...
#bag = rosbag.Bag('v_075_1.bag')
#print(bag)

#counter = 0
#f = open("nbvp_v0751.csv", "a")
#for topic, msg, t in bag.read_messages(topics=['/lc/path']):
#  if counter==41:
#    for i in range(len(msg.poses)):
#      if i==0:
#        offset=msg.poses[i].header.stamp
...
#counter = 0
#f = open("nbvp_v0751_gt.csv", "a")
#for topic, msg, t in bag.read_messages(topics=['/my_path']):
#  if counter==38:
#    for i in range(len(msg.poses)):
#      if i==0:
#        offset=msg.poses[i].header.stamp
