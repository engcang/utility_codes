...
for folder in os.listdir(base_folder):
    ...
    if os.path.isdir(folder_path):
        ...
        for prefix in prefixes:
            ...
            ground_truth_file = "tum_gt.csv"
            ground_truth_path = os.path.join(folder_path, ground_truth_file)

            # evo_ape 명령어 실행
            command = f"evo_rpe tum {ground_truth_path} {odom_path} -d 10 -u m --pose_relation point_distance"
...
results_df.to_csv("rmse_results_rpe.csv", sep= ' ', float_format='%.4f')
